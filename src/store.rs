...
use identity_account_storage::types::{AgreementInfo, CekAlgorithm, EncryptedData, EncryptionAlgorithm, KeyLocation, Signature};
use identity_account_storage::utils::Shared;
use identity_account_storage::Error;
use identity_account_storage::Result;
...
impl Storage for WaltStore {
    ...
    async fn chain_state_get(&self, did: &IotaDID) -> std::result::Result<Option<ChainState>, Error> {
    ...
    async fn document_get(&self, did: &IotaDID) -> std::result::Result<Option<IotaDocument>, Error> {
